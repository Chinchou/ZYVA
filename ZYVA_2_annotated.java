...
public class ZYVA_2 extends javax.swing.JFrame {
    
    public int x;  //tester for pressing buttons

    /**
     * Creates new form ZYVA
     */
    public ZYVA_2() {
      try {
            // Set System L&F
        ...
        //Options here: set to system default or use java built-in "metal"
        //could also figure out how to use various other look/feels
    } 
    ...
    //method that makes sure the new character is inserted at the caret
    //add in here that the focus does not change?
    public int getPos(){
    ...
    private void initComponents() {
      //all of the buttons.  buttons labled according to diagram
      //this is initiating all buttons.  could there be separate init components for each lang?
      //or will the change have to take place first, ie, in a splash/options screen
        ...
        //setting background.  if any extra time, try putting an image here again (hard!)
        Color c1 = new Color(75, 92, 112);
        ...
        setTitle("ZYVA--" + "\u00e9" + "crivez simplement en fran" + "\u00e7" + "ais !" + "    (Ver. 0.1.1)");
        setIconImages(null);
        setResizable(false);
        
        //zyva logo.  create logo for each lang, specifying the lang?  add this in to previously
        //mentioned switcher method?
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/ZYVAlogoproto.png"))); // NOI18N
